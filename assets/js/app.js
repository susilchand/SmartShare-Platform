...
function toggleThumbsUp() {
  ...
  var count = parseInt(thumbsUpCount.innerText);

  if (thumbsUpIcon.classList.contains('active')) {
      count++;
  } else {
      count--;
  }

  thumbsUpCount.innerText = count;
}

function toggleBookmark() {
  var bookmarkIcon = document.getElementById('bookmarkIcon');
  bookmarkIcon.classList.toggle('active-bookmark'); // Toggle the 'active-bookmark' class
}
//   for Profile Picture 
